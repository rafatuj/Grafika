...
GLboolean load_targa (const char *fimadonname, GLsizei &width, GLsizei &height,
...
GLboolean save_targa (const char *fimadonname, GLsizei width, GLsizei height,
                      GLenum format, GLenum type, GLvoid *pixels)
