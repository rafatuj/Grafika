...
void GenerateDisplayLists()
{
	...
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.01, 0.9, 1);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1.01, 0.9, 0.4);
	glTexCoord2f(1.0, 1.0);
	...
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-0.9, 0.0, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(-0.1, 0.0, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(-0.1, -1.0, 1.01);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(-0.9, -1.0, 1.01);
	/////////////////////////////////////////////////////////
	glTexCoord2f(0.0, 0.0);
	glVertex3f(0.9, 0.0, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(0.1, 0.0, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(0.1, -1, 1.01);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(0.9, -1, 1.01);
	
	/////////////////////////////////////////////////////////
	glTexCoord2f(0.0, 0.0);
	glVertex3f(1.01, 0, 1);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(1.01, 0, 0.2);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(1.01, -1, 0.2);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(1.01, -1, 1);
	...
	/////////////////////////////////////////////////////////
	glTexCoord2f(0.0, 0.0); 	
	glVertex3f(-1.01, 0, -0.9);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(-1.01, 0, -0.1);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(-1.01, -1, -0.1);
	glTexCoord2f(0.0, 1.0);
	glVertex3f(-1.01, -1, -0.9); 	
	/////////////////////////////////////////////////////////
